...
func Test_WStoreInt16_UseCase(t *testing.T) {
	...
	validateInt16History(chk, int16Store, "key1", 0, // next clk:clkNano2
		[]string{},
		[]int16{},
	)

	validateInt16History(chk, int16Store, "key2", 0, // next clk:clkNano2
		[]string{},
		[]int16{},
	)
	...
	validateInt16History(chk, int16Store, "key1", 0, // next clk:clkNano6
		[]string{"{{clkNano4}}"},
		[]int16{200},
	)

	validateInt16History(chk, int16Store, "key2", 0, // next clk:clkNano7
		[]string{"{{clkNano5}}"},
		[]int16{-200},
	)
	...
	validateInt16History(chk, int16Store, "key1", 0, // next clk:clkNano10
		[]string{},
		[]int16{},
	)

	validateInt16History(chk, int16Store, "key2", 0, // next clk:clkNano11
		[]string{},
		[]int16{},
	)
	...
	validateInt16History(chk, int16Store, "key1", 0, // next clk:clkNano14
		[]string{"{{clkNano12}}"},
		[]int16{222},
	)

	validateInt16History(chk, int16Store, "key2", 0, // next clk:clkNano15
		[]string{"{{clkNano13}}"},
		[]int16{-222},
	)
